...
ELASTICSEARCH_URLS = {
    '7.7.0': 'https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.7.0-linux-<arch>.tar.gz',
...
KMS_URL_PATTERN = 'https://s3-eu-west-2.amazonaws.com/local-kms/3/local-kms_<os>-<processor><alpine>.bin'
